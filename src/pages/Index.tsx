      ...
      <section className="py-24">
        <div className="container px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            desc: 'Берём на себя все задачи от подбора отеля до трансферов'
          }, {
            icon: Star,
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            num: '03',
            title: 'Концепция',
            desc: 'Предлагаем варианты маршрутов и отелей'
          }, {
            num: '04',
            title: 'Организация',
      ...
      <section className="py-24 bg-secondary/30">
        <div className="container px-4">
          ...
          <Accordion type="single" collapsible className="max-w-3xl mx-auto space-y-4">
            ...
            a: 'Мы организуем как индивидуальные поездки, так и групповые — семейные путешествия, корпоративные выезды, incentive-туры для компаний до 20 человек.'
          }, {
          ...
          }].map((faq, i) => <AccordionItem key={i} value={`item-${i}`} className="bg-card rounded-2xl border-0 px-6 shadow-sm">
        ...
        <div className="container px-4">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              ...
              <p className="text-background/80 leading-relaxed">Создаём премиальные путешествия под ключ с заботой о каждой детали</p>
            </div>
            <div>
              ...
              <div className="space-y-3 text-background/80">
                <div className="flex items-center gap-3">
                  ...
                  <a href="https://wa.me/79119269863" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-background/10 hover:bg-background/20 rounded-full flex items-center justify-center transition-colors">
                  ...
                  <a href="https://t.me/irina_travel_avenue" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-background/10 hover:bg-background/20 rounded-full flex items-center justify-center transition-colors">
                    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
