...
Тревел Авеню - это команда профессиональных тревел-консьержей, которые создают для Вас идеальные путешествия.
      ...
      <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" className="fixed bottom-8 right-8 w-16 h-16 bg-primary rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform z-50">
